...
class ConfigHeaderInfo(QWidget):
    ...
    def __init__(self, title="", parent=None):
        ...
        reg_hex8 = QRegExpValidator(QRegExp("0x[0-9A-Fa-f]{2}"))
        ...
        layout.addRow(QLabel("Version:"), self.CCFG_header_version)
        ...
        layout.addRow(QLabel("SPI NAND flash Quad Read Command:"), self.CCFG_header_quadread)
        layout.addRow(QLabel("SPI NAND flash Read Status Command:"), self.CCFG_header_readsts)
        layout.addRow(QLabel("SPI NAND flash Write Status Command:"), self.CCFG_header_writests)
        layout.addRow(QLabel("SPI Status Register Bit Value:"), self.CCFG_header_stsvalue)
        ...
        layout.addRow(QLabel("Entrypoint:"), self.CCFG_header_entrypoint)
...
class ConfigHeaderOption(QWidget):
    ...
    def __init__(self, title="", parent=None):
        ...
        layout.addRow(QLabel("Aeskey:"), self.CCFG_headeropt_aeskey_sublayout)
        layout.addRow(QLabel("Ecdsakey:"), self.CCFG_headeropt_ecdsakey_sublayout)
        ...
        for i in range (0, 4):
            ...
            self.CCFG_headeropt_image_type.append(QLineEdit(''))
            ...
            self.CCFG_headeropt_image_type[i].setValidator(reg_4int)
        
            index = i + 1
            layout.addRow(QLabel(f"Image {index} Offset:"), self.CCFG_headeropt_image_offset[i])
            layout.addRow(QLabel(f"Image {index} Loadaddr:"), self.CCFG_headeropt_image_loadaddr[i])
...
class ConfigEnvInfo(QWidget):
    ...
    def __init__(self, title="", parent=None):
        ...
        layout.addRow(QLabel("Block Size:"), self.CCFG_env_blksize)
        self.setLayout(layout)
...
class ConfigDataInfo(QWidget):
    ...
    def __init__(self, title="", parent=None):
        ...
        layout.addRow(QLabel("Aeskey:"), self.CCFG_data_aeskey)
        layout.addRow(QLabel("Ecdsakey:"), self.CCFG_data_ecdsakey)
...
class CCFG_MainPage(QWidget):
    ...
    def exportJson(self):
        ...
        if reg_hex32.validate(self.CCFG_Header.CCFG_header_version.text(),0)[0] == QValidator.Acceptable :
            header["version"] = self.CCFG_Header.CCFG_header_version.text()
        else:
        ...
        if reg_hex32.validate(self.CCFG_Header.CCFG_header_entrypoint.text(),0)[0] == QValidator.Acceptable :
            header["entrypoint"] = self.CCFG_Header.CCFG_header_entrypoint.text()
        else:
        ...
        reg_4int.validate(self.CCFG_HeaderOpt.CCFG_headeropt_image_type[0].text(),0)[0] == QValidator.Acceptable and
        self.CCFG_HeaderOpt.CCFG_headeropt_image_file[0].text() != "") :
            dict1 = {}
            dict1["offset"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_offset[0].text()
            dict1["loadaddr"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_loadaddr[0].text()
            dict1["type"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_type[0].text()
        ...
        reg_4int.validate(self.CCFG_HeaderOpt.CCFG_headeropt_image_type[1].text(),0)[0] == QValidator.Acceptable and
        self.CCFG_HeaderOpt.CCFG_headeropt_image_file[1].text() != "") :
            dict2 = {}
            dict2["offset"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_offset[1].text()
            dict2["loadaddr"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_loadaddr[1].text()
            dict2["type"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_type[1].text()
        ...
        reg_4int.validate(self.CCFG_HeaderOpt.CCFG_headeropt_image_type[2].text(),0)[0] == QValidator.Acceptable and
        self.CCFG_HeaderOpt.CCFG_headeropt_image_file[2].text() != "") :
            dict3 = {}
            dict3["offset"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_offset[2].text()
            dict3["loadaddr"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_loadaddr[2].text()
            dict3["type"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_type[2].text()
        ...
        reg_4int.validate(self.CCFG_HeaderOpt.CCFG_headeropt_image_type[3].text(),0)[0] == QValidator.Acceptable and
        self.CCFG_HeaderOpt.CCFG_headeropt_image_file[3].text() != "") :
            dict4 = {}
            dict4["offset"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_offset[3].text()
            dict4["loadaddr"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_loadaddr[3].text()
            dict4["type"] = self.CCFG_HeaderOpt.CCFG_headeropt_image_type[3].text()
